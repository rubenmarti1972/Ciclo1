...
const confirmarCita = async (idCita) => {
    let response = await fetch("https://misiontic2022upb.vercel.app/api/medical-appointments/confirm/1" + idCita,
        {
            method: "POST"
        }
    )
...
/*const API_URL = "https://misiontic2022upb.vercel.app/api/medicalappointments/confirm/"+idCita;
